...
parser.add_option("", "--config", default="idq.ini", type='string')
...
parser.add_option('', '--usertag', dest = "usertag", default=None, type = 'string', help="usertag to mark file names")
parser.add_option('', '--threshold', dest = "threshold", default=None, type='int', help="threshold for differentiating triggers")
...
### remove one unwanted segment
#scisegs.remove([1117790990, 1117793017])

print("Removed Segs: " + str(scisegs))
seglist = scisegs[:]
#==================================================================
for seg in seglist:
    scisegs = [seg]
    ...
    pat = idq.pat(output_dir, ifo, usertag, seg[0], seg[1]-seg[0])
